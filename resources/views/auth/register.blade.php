...
<body class="bg-white text-sm">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required
                            placeholder="Contoh: Irex Rusydiharjo"
    ...
    <script>
        let currentSlide = 0;
        const slides = [{
                title: "Temukan barang yang dicari",
                description: "Kami hadir membantu menemukan barang kesayangan Anda"
            },
            {
                title: "Hadir sebagai solusi",
                description: "Solusi modern untuk barang hilang dan ditemukan"
            },
            {
                title: "Selalu bawa barang kesayanganmu",
                description: "Jangan sampai kehilangan barang berhargamu"
            }
        ];
