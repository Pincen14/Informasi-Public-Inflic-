        ...
        <form action="{{ route('items.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-8">
                ...
                <div class="mb-4">
                    ...
                    <div class="mt-1 relative flex justify-center items-center px-6 py-8 border-2 border-gray-300 border-dashed rounded-xl hover:border-purple-500 transition cursor-pointer overflow-hidden min-h-[220px] bg-gray-50" 
                         onclick="document.getElementById('image').click()">
                        
                        <!-- Upload Placeholder -->
                        <div id="uploadPlaceholder" class="space-y-3 text-center flex flex-col items-center justify-center">
                            ...
                            <div class="text-sm text-gray-600">
                                <span class="font-semibold text-purple-600 hover:text-purple-500">Pilih foto</span> atau seret ke sini
                            </div>
                            <p class="text-xs text-gray-500">PNG, JPG, JPEG (Maksimal 2MB)</p>
                        </div>

                        <!-- Image Preview Container -->
                        <div id="imagePreviewContainer" class="absolute inset-0 hidden w-full h-full">
                            <img id="preview" src="" alt="Preview" class="w-full h-full object-cover">
                            <!-- Change Overlay -->
                            <div class="absolute inset-0 bg-black/40 opacity-0 hover:opacity-100 transition duration-150 flex items-center justify-center text-white font-medium text-sm gap-2">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 1121.21 8H18.2M7 9a3 3 0 11-6 0 3 3 0 016 0z" />
                                </svg>
                                Ubah Foto
                            </div>
                        </div>
